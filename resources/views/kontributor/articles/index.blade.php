...
@section('content')
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div
                class="bg-white rounded-xl shadow-sm p-5 border-l-4 border-blue-500 hover:shadow-md transition-shadow duration-300">
                <div class="flex items-center justify-between">
                    ...
                    <div
                        class="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center shadow-md">
            ...
            <div
                class="bg-white rounded-xl shadow-sm p-5 border-l-4 border-green-500 hover:shadow-md transition-shadow duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs sm:text-sm text-gray-600 font-medium">Published</p>
                        <h3 class="text-2xl sm:text-3xl font-bold text-gray-800 mt-1">
                            {{ $articles->where('status', 'published')->count() }}</h3>
                    </div>
                    <div
                        class="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-green-400 to-green-600 rounded-xl flex items-center justify-center shadow-md">
            ...
            <div
                class="bg-white rounded-xl shadow-sm p-5 border-l-4 border-gray-500 hover:shadow-md transition-shadow duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs sm:text-sm text-gray-600 font-medium">Draft</p>
                        <h3 class="text-2xl sm:text-3xl font-bold text-gray-800 mt-1">
                            {{ $articles->where('status', 'draft')->count() }}</h3>
                    </div>
                    <div
                        class="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-gray-400 to-gray-600 rounded-xl flex items-center justify-center shadow-md">
            ...
            <div
                class="bg-white rounded-xl shadow-sm p-5 border-l-4 border-amber-500 hover:shadow-md transition-shadow duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs sm:text-sm text-gray-600 font-medium">Pending</p>
                        <h3 class="text-2xl sm:text-3xl font-bold text-gray-800 mt-1">
                            {{ $articles->where('status', 'pending')->count() }}</h3>
                    </div>
                    <div
                        class="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-amber-400 to-amber-600 rounded-xl flex items-center justify-center shadow-md">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-start gap-3">
                                            ...
                                            @else
                                                <div
                                                    class="w-16 h-16 bg-gradient-to-br from-amber-400 to-amber-600 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm">
                    ...
                    @foreach ($articles as $article)
                        <div class="p-4 hover:bg-gray-50 transition-colors duration-150">
                            <div class="flex gap-3 mb-3">
                                ...
                                @else
                                    <div
                                        class="w-20 h-20 bg-gradient-to-br from-amber-400 to-amber-600 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm">
            ...
            @else
                <div class="p-16 text-center">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-gray-500 mb-4">Mulai berbagi pengetahuan dengan menulis artikel pertama Anda
                        </p>
                        <a href="{{ route('kontributor.articles.create') }}"
