    ...
    <div class="w-full max-w-md z-10">
        <div class="glass-card rounded-2xl shadow-2xl p-8 text-center transform transition-all hover:scale-[1.01]">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-500 text-sm mt-2">Jangan khawatir! Masukkan email Anda dan kami akan mengirimkan
                    link reset.</p>
            </div>
            ...
            <form action="{{ route('password.email') }}" method="POST" class="space-y-5">
                ...
                <div class="relative group text-left">
                    <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1 ml-1">Email
                        Terdaftar</label>
                    <span
                        class="absolute inset-y-0 left-0 flex items-center pl-4 pt-6 text-gray-400 group-focus-within:text-amber-500 transition-colors">
                ...
                <button type="submit"
                    class="w-full bg-amber-500 hover:bg-amber-600 text-white font-bold py-3.5 rounded-xl shadow-lg hover:shadow-amber-500/30 transition-all">
                    Kirim Link Reset
                </button>
            </form>
            ...
            <div class="mt-8 pt-6 border-t border-gray-100">
                <a href="{{ route('login') }}"
                    class="inline-flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-amber-600 transition-colors">
