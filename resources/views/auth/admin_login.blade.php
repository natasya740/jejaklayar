...
<body class="antialiased text-gray-800">
    ...
    <div class="flex justify-center items-center min-h-screen p-4">
        ...
        <div
            class="flex w-full max-w-5xl bg-white rounded-2xl shadow-2xl overflow-hidden min-h-[650px]
            ...
            <div class="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-white relative">
                ...
                @if ($errors->any())
                    <div
                        class="bg-red-50 border-l-4 border-red-500 text-red-700 p-4 rounded-r mb-6 text-sm shadow-sm animate-pulse">
                ...
                <form action="{{ route('login.admin.post') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <span
                                class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400 group-focus-within:text-amber-500">
