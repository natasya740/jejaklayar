...
<body class="antialiased text-gray-800">
    ...
    <div class="flex justify-center items-center min-h-screen p-4">
        ...
        <div
            ...
            <div class="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center bg-white relative overflow-y-auto">
                <!-- Header untuk Mobile -->
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-500 text-sm">Bergabung dan mulai berkontribusi.</p>
                </div>
                ...
                <a href="{{ route('auth.google') }}"
                    class="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-3.5 rounded-xl shadow-sm transition-all duration-200 mb-5">
