{{-- resources/views/admin/sub-categories/create.blade.php --}}
@extends('layouts.dashboard_admin')

@section('title', 'Tambah Sub Kategori')

@section('page-title', 'Tambah Sub Kategori')
@section('page-subtitle', 'Buat sub kategori baru untuk artikel')
    ...
    <div class="bg-gradient-to-r from-[color:var(--yellow-1)] to-[color:var(--yellow-2)] rounded-xl shadow-lg p-6 mb-6">
        <div class="flex items-center gap-4">
            ...
            <div class="text-white">
                <h2 class="text-2xl font-bold mb-1">Tambah Sub Kategori Baru</h2>
                <p class="text-white/80">Buat sub kategori baru untuk mengorganisir artikel lebih spesifik</p>
            </div>
        </div>
    </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[color:var(--yellow-2)] focus:border-transparent transition-all appearance-none bg-white @error('category_id') border-red-500 @enderror" 
                                id="category_id" 
                                name="category_id" 
                                required>
                    ...
                    <p class="mt-2 text-sm text-[color:var(--muted)] flex items-center gap-1">
                        ...
                        <span>Pilih kategori induk untuk sub kategori ini</span>
                    </p>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i class="fa fa-folder-open text-[color:var(--yellow-2)]"></i>
                        </div>
                        <input type="text" 
                    ...
                    <p class="mt-2 text-sm text-[color:var(--muted)] flex items-center gap-1">
                        <i class="fa fa-info-circle"></i>
                        <span>Slug akan dibuat otomatis dari nama sub kategori</span>
                    </p>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex gap-3">
                        ...
                        <div class="flex-1">
                            <h4 class="text-sm font-semibold text-blue-900 mb-1">Tips Pembuatan Sub Kategori</h4>
                            <ul class="text-sm text-blue-800 space-y-1">
                                <li>• Sub kategori membantu mengorganisir artikel lebih spesifik dalam kategori</li>
                                <li>• Gunakan nama yang jelas dan mendeskripsikan konten dengan baik</li>
                                <li>• Sub kategori akan mempermudah pencarian artikel bagi pengunjung</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-[var(--shadow-sm)] p-6 mt-6">
        ...
        <div class="space-y-3 text-sm text-[color:var(--muted)]">
            <div class="flex gap-3">
                ...
                <p>Sub kategori harus berada di bawah kategori induk yang sudah ada</p>
            </div>
            <div class="flex gap-3">
                <i class="fa fa-check-circle text-green-500 mt-0.5"></i>
                <p>Nama sub kategori harus unik dalam satu kategori induk</p>
            </div>
            <div class="flex gap-3">
                <i class="fa fa-check-circle text-green-500 mt-0.5"></i>
                <p>Slug akan otomatis dibuat dari nama sub kategori (huruf kecil, tanpa spasi)</p>
            </div>
            <div class="flex gap-3">
                <i class="fa fa-check-circle text-green-500 mt-0.5"></i>
                <p>Deskripsi membantu menjelaskan jenis konten spesifik dalam sub kategori</p>
            </div>
        </div>
    </div>
</div>
